...
public class UserRegistrationTest {
    ...
    @Test
    public void givenPassword01_WhenProper_ShouldReturnTrue() throws UserRegistrationException {
        UserRegistration userRegistration = new UserRegistration();
    ...
    @Test
    public void givenPassword02_WhenProper_ShouldReturnTrue() throws UserRegistrationException {
        UserRegistration userRegistration = new UserRegistration();
    ...
    @Test
    public void givenPassword03_WhenProper_ShouldReturnTrue() throws UserRegistrationException {
        UserRegistration userRegistration = new UserRegistration();
    ...
    @Test
    public void givenPassword04_WhenProper_ShouldReturnTrue() throws UserRegistrationException {
        UserRegistration userRegistration = new UserRegistration();
        boolean result = userRegistration.validatePassword04("Akshar@1");
        Assertions.assertTrue(result);
    }
}
